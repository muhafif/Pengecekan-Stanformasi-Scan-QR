            ...
            <div class="card shadow bg-body-tertiary rounded">
                <div class="card-body">
                    ...
                    <div class="card shadow bg-body-tertiary rounded" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 1)) ,url(https://swamediainc.storage.googleapis.com/swa.co.id/wp-content/uploads/2020/05/12191311/Kereta-APi.jpg);">
                        <a div class="card-body" href="../QR/SCANQRTKS67.php" style="justify-content: center; align-items: center; display: flex;"
                            data-bs-toggle="modal" data-bs-target="#modalLuxuryTaksaka67">
                            <button type="button" class="btn btn-lg" style="color: white;">
                    ...
                    <div class="card shadow bg-body-tertiary rounded" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 1)) ,url(https://swamediainc.storage.googleapis.com/swa.co.id/wp-content/uploads/2020/05/12191311/Kereta-APi.jpg);">
                        <a div class="card-body" href="../QR/SCANQRTKS67.php" style="justify-content: center; align-items: center; display: flex;"
                            data-bs-toggle="modal" data-bs-target="#modalEks1Taksaka67">
                            <button type="button" class="btn btn-lg" style="color: white;">
                    ...
                    <div class="card shadow bg-body-tertiary rounded" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 1)) ,url(https://swamediainc.storage.googleapis.com/swa.co.id/wp-content/uploads/2020/05/12191311/Kereta-APi.jpg);">
                        <a div class="card-body" href="../QR/SCANQRTKS67.php" style="justify-content: center; align-items: center; display: flex;"
                            data-bs-toggle="modal" data-bs-target="#modalEks2Taksaka67">
                            <button type="button" class="btn btn-lg" style="color: white;">
                    ...
                    <div class="card shadow bg-body-tertiary rounded" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 1)) ,url(https://swamediainc.storage.googleapis.com/swa.co.id/wp-content/uploads/2020/05/12191311/Kereta-APi.jpg);">
                        <a div class="card-body" href="../QR/SCANQRTKS67.php" style="justify-content: center; align-items: center; display: flex;"
                            data-bs-toggle="modal" data-bs-target="#modalEks3Taksaka67">
                            <button type="button" class="btn btn-lg" style="color: white;">
                    ...
                    <div class="card shadow bg-body-tertiary rounded" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 1)) ,url(https://swamediainc.storage.googleapis.com/swa.co.id/wp-content/uploads/2020/05/12191311/Kereta-APi.jpg);">
                        <a div class="card-body" href="../QR/SCANQRTKS67.php" style="justify-content: center; align-items: center; display: flex;"
                            data-bs-toggle="modal" data-bs-target="#modalEks4Taksaka67">
                            <button type="button" class="btn btn-lg" style="color: white;">
                    ...
                    <div class="card shadow bg-body-tertiary rounded" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 1)) ,url(https://swamediainc.storage.googleapis.com/swa.co.id/wp-content/uploads/2020/05/12191311/Kereta-APi.jpg);">
                        <a div class="card-body" href="../QR/SCANQRTKS67.php" style="justify-content: center; align-items: center; display: flex;"
                            data-bs-toggle="modal" data-bs-target="#modalEks5Taksaka67">
                            <button type="button" class="btn btn-lg" style="color: white;">
                    ...
                    <div class="card shadow bg-body-tertiary rounded" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 1)) ,url(https://swamediainc.storage.googleapis.com/swa.co.id/wp-content/uploads/2020/05/12191311/Kereta-APi.jpg);">
                        <a div class="card-body" href="../QR/SCANQRTKS67.php" style="justify-content: center; align-items: center; display: flex;"
                            data-bs-toggle="modal" data-bs-target="#modalEks6Taksaka67">
                            <button type="button" class="btn btn-lg" style="color: white;">
                    ...
                    <div class="card shadow bg-body-tertiary rounded" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 1)) ,url(https://swamediainc.storage.googleapis.com/swa.co.id/wp-content/uploads/2020/05/12191311/Kereta-APi.jpg);">
                        <a div class="card-body" href="../QR/SCANQRTKS67.php" style="justify-content: center; align-items: center; display: flex;"
                            data-bs-toggle="modal" data-bs-target="#modalEks7Taksaka67">
                            <button type="button" class="btn btn-lg" style="color: white;">
                    ...
                    <div class="card shadow bg-body-tertiary rounded" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 1)) ,url(https://swamediainc.storage.googleapis.com/swa.co.id/wp-content/uploads/2020/05/12191311/Kereta-APi.jpg);">
                        <a div class="card-body" href="../QR/SCANQRTKS67.php" style="justify-content: center; align-items: center; display: flex;"
                            data-bs-toggle="modal" data-bs-target="#modalEks8Taksaka67">
                            <button type="button" class="btn btn-lg" style="color: white;">
                    ...
                    <div class="card shadow bg-body-tertiary rounded" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 1)) ,url(https://swamediainc.storage.googleapis.com/swa.co.id/wp-content/uploads/2020/05/12191311/Kereta-APi.jpg);">
                        <a div class="card-body" href="../QR/SCANQRTKS67.php" style="justify-content: center; align-items: center; display: flex;"
                            data-bs-toggle="modal" data-bs-target="#modalEks9Taksaka67">
                            <button type="button" class="btn btn-lg" style="color: white;">
