...
<body>
            ...
            <div class="card shadow bg-body-tertiary rounded">
                <div class="card-pertama shadow bg-body-tertiary rounded" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 1)), url(https://swamediainc.storage.googleapis.com/swa.co.id/wp-content/uploads/2020/05/12191311/Kereta-APi.jpg); color: white;">
                    <div class="card-sepursatu">
                        <center><strong><div class="jenenge-sepur">ARGO DWIPANGGA (10)</div></strong></center>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="card shadow bg-body-tertiary rounded" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 1)) ,url(https://swamediainc.storage.googleapis.com/swa.co.id/wp-content/uploads/2020/05/12191311/Kereta-APi.jpg);">
                        <div class="card-body" style="justify-content: center; align-items: center; display: flex;">
                            ...
                            data-bs-target="#modalLuxuryArgoDWP10"><strong>LUXURY</strong></button>
                        </div>
                    </div>
                    <div class="b-example-divider-main"></div>
                    <div class="card shadow bg-body-tertiary rounded" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 1)) ,url(https://swamediainc.storage.googleapis.com/swa.co.id/wp-content/uploads/2020/05/12191311/Kereta-APi.jpg);">
                        <div class="card-body" style="justify-content: center; align-items: center; display: flex;">
                            <button type="button" class="btn btn-lg" style="color: white;"
                            data-bs-toggle="modal"
                            data-bs-target="#modalEks1ArgoDWP10"><strong>EKSEKUTIF 1</strong></button>
                        </div>
                    </div>
                    <div class="b-example-divider-main"></div>
                    <div class="card shadow bg-body-tertiary rounded" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 1)) ,url(https://swamediainc.storage.googleapis.com/swa.co.id/wp-content/uploads/2020/05/12191311/Kereta-APi.jpg);">
                        <div class="card-body" style="justify-content: center; align-items: center; display: flex;">
                            <button type="button" class="btn btn-lg" style="color: white;"
                            data-bs-toggle="modal"
                            data-bs-target="#modalEks2ArgoDWP10"><strong>EKSEKUTIF 2</strong></button>
                        </div>
                    </div>
                    <div class="b-example-divider-main"></div>
                    <div class="card shadow bg-body-tertiary rounded" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 1)) ,url(https://swamediainc.storage.googleapis.com/swa.co.id/wp-content/uploads/2020/05/12191311/Kereta-APi.jpg);">
                        <div class="card-body" style="justify-content: center; align-items: center; display: flex;">
                            <button type="button" class="btn btn-lg" style="color: white;"
                            data-bs-toggle="modal"
                            data-bs-target="#modalEks3ArgoDWP10"><strong>EKSEKUTIF 3</strong></button>
                        </div>
                    </div>
                    <div class="b-example-divider-main"></div>
                    <div class="card shadow bg-body-tertiary rounded" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 1)) ,url(https://swamediainc.storage.googleapis.com/swa.co.id/wp-content/uploads/2020/05/12191311/Kereta-APi.jpg);">
                        <div class="card-body" style="justify-content: center; align-items: center; display: flex;">
                            <button type="button" class="btn btn-lg" style="color: white;"
                            data-bs-toggle="modal"
                            data-bs-target="#modalEks4ArgoDWP10"><strong>EKSEKUTIF 4</strong></button>
                        </div>
                    </div>
                    <div class="b-example-divider-main"></div>
                    <div class="card shadow bg-body-tertiary rounded" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 1)) ,url(https://swamediainc.storage.googleapis.com/swa.co.id/wp-content/uploads/2020/05/12191311/Kereta-APi.jpg);">
                        <div class="card-body" style="justify-content: center; align-items: center; display: flex;">
                            <button type="button" class="btn btn-lg" style="color: white;"
                            data-bs-toggle="modal"
                            data-bs-target="#modalEks5ArgoDWP10"><strong>EKSEKUTIF 5</strong></button>
                        </div>
                    </div>
                    <div class="b-example-divider-main"></div>
                    <div class="card shadow bg-body-tertiary rounded" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 1)) ,url(https://swamediainc.storage.googleapis.com/swa.co.id/wp-content/uploads/2020/05/12191311/Kereta-APi.jpg);">
                        <div class="card-body" style="justify-content: center; align-items: center; display: flex;">
                            <button type="button" class="btn btn-lg" style="color: white;"
                            data-bs-toggle="modal"
                            data-bs-target="#modalEks6ArgoDWP10"><strong>EKSEKUTIF 6</strong></button>
                        </div>
                    </div>
                    <div class="b-example-divider-main"></div>
                    <div class="card shadow bg-body-tertiary rounded" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 1)) ,url(https://swamediainc.storage.googleapis.com/swa.co.id/wp-content/uploads/2020/05/12191311/Kereta-APi.jpg);">
                        <div class="card-body" style="justify-content: center; align-items: center; display: flex;">
                            <button type="button" class="btn btn-lg" style="color: white;"
                            data-bs-toggle="modal"
                            data-bs-target="#modalEks7ArgoDWP10"><strong>EKSEKUTIF 7</strong></button>
                        </div>
                    </div>
                    <div class="b-example-divider-main"></div>
                    <div class="card shadow bg-body-tertiary rounded" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 1)) ,url(https://swamediainc.storage.googleapis.com/swa.co.id/wp-content/uploads/2020/05/12191311/Kereta-APi.jpg);">
                        <div class="card-body" style="justify-content: center; align-items: center; display: flex;">
                            <button type="button" class="btn btn-lg" style="color: white;"
                            data-bs-toggle="modal"
                            data-bs-target="#modalEks8ArgoDWP10"><strong>EKSEKUTIF 8</strong></button>
                        </div>
                    </div>
                    <div class="b-example-divider-main"></div>
                    <div class="card shadow bg-body-tertiary rounded" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 1)) ,url(https://swamediainc.storage.googleapis.com/swa.co.id/wp-content/uploads/2020/05/12191311/Kereta-APi.jpg);">
                        <div class="card-body" style="justify-content: center; align-items: center; display: flex;">
                            <button type="button" class="btn btn-lg" style="color: white;"
                            data-bs-toggle="modal"
                            data-bs-target="#modalEks9ArgoDWP10"><strong>EKSEKUTIF 9</strong></button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-4 shadow">
                <div class="modal-body p-4 text-center border-bottom-2">
                    <h5 class="mb-0">Ingin Memulai Scan Stanformasi Luxury Di Kereta Argo Dwipangga(10)?</h5>
                    <div class="b-example-divider-main"></div>
    ...
    <div class="modal fade" id="modalEks1ArgoDWP10" tabindex="-1" aria-labelledby="modalEks1ArgoDWP10Label" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-4 shadow">
                <div class="modal-body p-4 text-center border-bottom-2">
                    <h5 class="mb-0">Ingin Memulai Scan Stanformasi Eksekutif 1 Di Kereta Argo Dwipangga(10)?</h5>
                    <div class="b-example-divider-main"></div>
                    <p class="mb-0">Stanformasi yang dipilih tidak dapat diubah!</p>
                </div>
                <div class="modal-footer justify-content-around">
    ...
    <div class="modal fade" id="modalEks2ArgoDWP10" tabindex="-1" aria-labelledby="modalEks2ArgoDWP10Label" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centereTaksaka67d">
            <div class="modal-content rounded-4 shadow">
                <div class="modal-body p-4 text-center border-bottom-2">
                    <h5 class="mb-0">Ingin Memulai Scan Stanformasi Eksekutif 2 Di Kereta Argo Dwipangga(10)?</h5>
                    <div class="b-example-divider-main"></div>
                    <p class="mb-0">Stanformasi yang dipilih tidak dapat diubah!</p>
                </div>
                <div class="modal-footer justify-content-around">
    ...
    <div class="modal fade" id="modalEks3ArgoDWP10" tabindex="-1" aria-labelledby="modalEks3ArgoDWP10Label" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-4 shadow">
                <div class="modal-body p-4 text-center border-bottom-2">
                    <h5 class="mb-0">Ingin Memulai Scan Stanformasi Eksekutif 3 Di Kereta Argo Dwipangga (10)?</h5>
                    <div class="b-example-divider-main"></div>
                    <p class="mb-0">Stanformasi yang dipilih tidak dapat diubah!</p>
                </div>
                <div class="modal-footer justify-content-around">
    ...
    <div class="modal fade" id="modalEks4ArgoDWP10" tabindex="-1" aria-labelledby="modalEks4ArgoDWP10Label" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-4 shadow">
                <div class="modal-body p-4 text-center border-bottom-2">
                    <h5 class="mb-0">Ingin Memulai Scan Stanformasi Eksekutif 4 Di Kereta Argo Dwipangga(10)?</h5>
                    <div class="b-example-divider-main"></div>
                    <p class="mb-0">Stanformasi yang dipilih tidak dapat diubah!</p>
                </div>
                <div class="modal-footer justify-content-around">
    ...
    <div class="modal fade" id="modalEks5ArgoDWP10" tabindex="-1" aria-labelledby="modalEks5ArgoDWP10Label" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-4 shadow">
                <div class="modal-body p-4 text-center border-bottom-2">
                    <h5 class="mb-0">Ingin Memulai Scan Stanformasi Eksekutif 5 Di Kereta Argo Dwipangga (10)?</h5>
                    <div class="b-example-divider-main"></div>
                    <p class="mb-0">Stanformasi yang dipilih tidak dapat diubah!</p>
                </div>
                <div class="modal-footer justify-content-around">
