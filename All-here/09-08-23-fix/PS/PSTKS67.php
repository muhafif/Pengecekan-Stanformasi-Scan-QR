...
<body>
                ...
                <div class="card-body">
                    ...
                    <div class="card shadow bg-body-tertiary rounded" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 1)) ,url(https://swamediainc.storage.googleapis.com/swa.co.id/wp-content/uploads/2020/05/12191311/Kereta-APi.jpg);">
                        <div class="card-body" style="justify-content: center; align-items: center; display: flex;">
                            <button type="button" class="btn btn-lg" style="color: white;"
                            data-bs-toggle="modal"
                            data-bs-target="#modalEks1Taksaka67"><strong>EKSEKUTIF 1</strong></button>
                        </div>
                    </div>
                    <div class="b-example-divider-main"></div>
                    <div class="card shadow bg-body-tertiary rounded" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 1)) ,url(https://swamediainc.storage.googleapis.com/swa.co.id/wp-content/uploads/2020/05/12191311/Kereta-APi.jpg);">
                        <div class="card-body" style="justify-content: center; align-items: center; display: flex;">
                            <button type="button" class="btn btn-lg" style="color: white;"
                            data-bs-toggle="modal"
                            data-bs-target="#modalEks2Taksaka67"><strong>EKSEKUTIF 2</strong></button>
                        </div>
                    </div>
                    <div class="b-example-divider-main"></div>
                    <div class="card shadow bg-body-tertiary rounded" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 1)) ,url(https://swamediainc.storage.googleapis.com/swa.co.id/wp-content/uploads/2020/05/12191311/Kereta-APi.jpg);">
                        <div class="card-body" style="justify-content: center; align-items: center; display: flex;">
                            <button type="button" class="btn btn-lg" style="color: white;"
                            data-bs-toggle="modal"
                            data-bs-target="#modalEks3Taksaka67"><strong>EKSEKUTIF 3</strong></button>
                        </div>
                    </div>
                    <div class="b-example-divider-main"></div>
                    <div class="card shadow bg-body-tertiary rounded" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 1)) ,url(https://swamediainc.storage.googleapis.com/swa.co.id/wp-content/uploads/2020/05/12191311/Kereta-APi.jpg);">
                        <div class="card-body" style="justify-content: center; align-items: center; display: flex;">
                            <button type="button" class="btn btn-lg" style="color: white;"
                            data-bs-toggle="modal"
                            data-bs-target="#modalEks4Taksaka67"><strong>EKSEKUTIF 4</strong></button>
                        </div>
                    </div>
                    <div class="b-example-divider-main"></div>
                    <div class="card shadow bg-body-tertiary rounded" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 1)) ,url(https://swamediainc.storage.googleapis.com/swa.co.id/wp-content/uploads/2020/05/12191311/Kereta-APi.jpg);">
                        <div class="card-body" style="justify-content: center; align-items: center; display: flex;">
                            <button type="button" class="btn btn-lg" style="color: white;"
                            data-bs-toggle="modal"
                            data-bs-target="#modalEks5Taksaka67"><strong>EKSEKUTIF 5</strong></button>
                        </div>
                    </div>
                    <div class="b-example-divider-main"></div>
                    <div class="card shadow bg-body-tertiary rounded" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 1)) ,url(https://swamediainc.storage.googleapis.com/swa.co.id/wp-content/uploads/2020/05/12191311/Kereta-APi.jpg);">
                        <div class="card-body" style="justify-content: center; align-items: center; display: flex;">
                            <button type="button" class="btn btn-lg" style="color: white;"
                            data-bs-toggle="modal"
                            data-bs-target="#modalEks6Taksaka67"><strong>EKSEKUTIF 6</strong></button>
                        </div>
                    </div>
                    <div class="b-example-divider-main"></div>
                    <div class="card shadow bg-body-tertiary rounded" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 1)) ,url(https://swamediainc.storage.googleapis.com/swa.co.id/wp-content/uploads/2020/05/12191311/Kereta-APi.jpg);">
                        <div class="card-body" style="justify-content: center; align-items: center; display: flex;">
                            <button type="button" class="btn btn-lg" style="color: white;"
                            data-bs-toggle="modal"
                            data-bs-target="#modalEks7Taksaka67"><strong>EKSEKUTIF 7</strong></button>
                        </div>
                    </div>
                    <div class="b-example-divider-main"></div>
                    <div class="card shadow bg-body-tertiary rounded" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 1)) ,url(https://swamediainc.storage.googleapis.com/swa.co.id/wp-content/uploads/2020/05/12191311/Kereta-APi.jpg);">
                        <div class="card-body" style="justify-content: center; align-items: center; display: flex;">
                            <button type="button" class="btn btn-lg" style="color: white;"
                            data-bs-toggle="modal"
                            data-bs-target="#modalEks8Taksaka67"><strong>EKSEKUTIF 8</strong></button>
                        </div>
                    </div>
                    <div class="b-example-divider-main"></div>
                    <div class="card shadow bg-body-tertiary rounded" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 1)) ,url(https://swamediainc.storage.googleapis.com/swa.co.id/wp-content/uploads/2020/05/12191311/Kereta-APi.jpg);">
                        <div class="card-body" style="justify-content: center; align-items: center; display: flex;">
                            <button type="button" class="btn btn-lg" style="color: white;"
                            data-bs-toggle="modal"
                            data-bs-target="#modalEks9Taksaka67"><strong>EKSEKUTIF 9</strong></button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-4 shadow">
                ...
                <div class="modal-footer justify-content-around">
                    ...
                    <a href="../QR/SCANQRTKS67.php">
                        <button type="button" class="btn btn-primary" onclick="lux()">Mulai</button></a>
                        <script>
                        function lux() {
    ...
    <div class="modal fade" id="modalEks1Taksaka67" tabindex="-1" aria-labelledby="modalEks1Taksaka67Label" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-4 shadow">
                <div class="modal-body p-4 text-center border-bottom-2">
    ...
    <div class="modal fade" id="modalEks2Taksaka67" tabindex="-1" aria-labelledby="modalEks2Taksaka67Label" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-4 shadow">
                <div class="modal-body p-4 text-center border-bottom-2">
                    <h5 class="mb-0">Ingin Memulai Scan Stanformasi Eksekutif 2 Di Kereta Taksaka(67)?</h5>
                    <div class="b-example-divider-main"></div>
                    <p class="mb-0">Stanformasi yang dipilih tidak dapat diubah!</p>
                </div>
                <div class="modal-footer justify-content-around">
                    <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Batal</button>
                    <a href="../QR/SCANQRTKS67.php">
                        <button type="button" class="btn btn-primary" onclick="EKS2()">Mulai</button></a>
                        <script>
                        function EKS2() {
                            var xhr = new XMLHttpRequest();
                            xhr.open('POST', '../config/insertTKS67.php', true);
    ...
    <div class="modal fade" id="modalEks3Taksaka67" tabindex="-1" aria-labelledby="modalEks3Taksaka67Label" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-4 shadow">
                <div class="modal-body p-4 text-center border-bottom-2">
                    <h5 class="mb-0">Ingin Memulai Scan Stanformasi Eksekutif 3 Di Kereta Taksaka(67)?</h5>
                    <div class="b-example-divider-main"></div>
                    <p class="mb-0">Stanformasi yang dipilih tidak dapat diubah!</p>
                </div>
                <div class="modal-footer justify-content-around">
                    <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Batal</button>
                    <a href="../QR/SCANQRTKS67.php">
                        <button type="button" class="btn btn-primary" onclick="EKS3()">Mulai</button></a>
                        <script>
                        function EKS3() {
                            var xhr = new XMLHttpRequest();
                            xhr.open('POST', '../config/insertTKS67.php', true);
    ...
    <div class="modal fade" id="modalEks4Taksaka67" tabindex="-1" aria-labelledby="modalEks4Taksaka67Label" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-4 shadow">
                <div class="modal-body p-4 text-center border-bottom-2">
                    <h5 class="mb-0">Ingin Memulai Scan Stanformasi Eksekutif 4 Di Kereta Taksaka(67)?</h5>
                    <div class="b-example-divider-main"></div>
                    <p class="mb-0">Stanformasi yang dipilih tidak dapat diubah!</p>
                </div>
                <div class="modal-footer justify-content-around">
                    <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Batal</button>
                    <a href="../QR/SCANQRTKS67.php">
                        <button type="button" class="btn btn-primary" onclick="EKS4()">Mulai</button></a>
                        <script>
                        function EKS4() {
                            var xhr = new XMLHttpRequest();
                            xhr.open('POST', '../config/insertTKS67.php', true);
    ...
    <div class="modal fade" id="modalEks5Taksaka67" tabindex="-1" aria-labelledby="modalEks5Taksaka67Label" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-4 shadow">
                <div class="modal-body p-4 text-center border-bottom-2">
                    <h5 class="mb-0">Ingin Memulai Scan Stanformasi Eksekutif 5 Di Kereta Taksaka(67)?</h5>
                    <div class="b-example-divider-main"></div>
                    <p class="mb-0">Stanformasi yang dipilih tidak dapat diubah!</p>
                </div>
                <div class="modal-footer justify-content-around">
                    <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Batal</button>
                    <a href="../QR/SCANQRTKS67.php">
                        <button type="button" class="btn btn-primary" onclick="EKS5()">Mulai</button></a>
                        <script>
                        function EKS5() {
                            var xhr = new XMLHttpRequest();
                            xhr.open('POST', '../config/insertTKS67.php', true);
    ...
    <div class="modal fade" id="modalEks6Taksaka67" tabindex="-1" aria-labelledby="modalEks6Taksaka67Label" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-4 shadow">
                <div class="modal-body p-4 text-center border-bottom-2">
                    <h5 class="mb-0">Ingin Memulai Scan Stanformasi Eksekutif 6 Di Kereta Taksaka(67)?</h5>
                    <div class="b-example-divider-main"></div>
                    <p class="mb-0">Stanformasi yang dipilih tidak dapat diubah!</p>
                </div>
                <div class="modal-footer justify-content-around">
                    <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Batal</button>
                    <a href="../QR/SCANQRTKS67.php">
                        <button type="button" class="btn btn-primary" onclick="EKS6()">Mulai</button></a>
                        <script>
                        function EKS6() {
                            var xhr = new XMLHttpRequest();
                            xhr.open('POST', '../config/insertTKS67.php', true);
    ...
    <div class="modal fade" id="modalEks7Taksaka67" tabindex="-1" aria-labelledby="modalEks7Taksaka67Label" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-4 shadow">
                <div class="modal-body p-4 text-center border-bottom-2">
                    <h5 class="mb-0">Ingin Memulai Scan Stanformasi Eksekutif 7 Di Kereta Taksaka(67)?</h5>
                    <div class="b-example-divider-main"></div>
                    <p class="mb-0">Stanformasi yang dipilih tidak dapat diubah!</p>
                </div>
                <div class="modal-footer justify-content-around">
                    <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Batal</button>
                    <a href="../QR/SCANQRTKS67.php">
                        <button type="button" class="btn btn-primary" onclick="EKS7()">Mulai</button></a>
                        <script>
                        function EKS7() {
                            var xhr = new XMLHttpRequest();
                            xhr.open('POST', '../config/insertTKS67.php', true);
    ...
    <div class="modal fade" id="modalEks8Taksaka67" tabindex="-1" aria-labelledby="modalEks8Taksaka67Label" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-4 shadow">
                <div class="modal-body p-4 text-center border-bottom-2">
                    <h5 class="mb-0">Ingin Memulai Scan Stanformasi Eksekutif 8 Di Kereta Taksaka(67)?</h5>
                    <div class="b-example-divider-main"></div>
                    <p class="mb-0">Stanformasi yang dipilih tidak dapat diubah!</p>
                </div>
                <div class="modal-footer justify-content-around">
                    <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Batal</button>
                    <a href="../QR/SCANQRTKS67.php">
                        <button type="button" class="btn btn-primary" onclick="EKS8()">Mulai</button></a>
                        <script>
                        function EKS8() {
                            var xhr = new XMLHttpRequest();
                            xhr.open('POST', '../config/insertTKS67.php', true);
    ...
    <div class="modal fade" id="modalEks9Taksaka67" tabindex="-1" aria-labelledby="modalEks9Taksaka67Label" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-4 shadow">
                <div class="modal-body p-4 text-center border-bottom-2">
                    <h5 class="mb-0">Ingin Memulai Scan Stanformasi Eksekutif 9 Di Kereta Taksaka(67)?</h5>
                    <div class="b-example-divider-main"></div>
                    <p class="mb-0">Stanformasi yang dipilih tidak dapat diubah!</p>
                </div>
                <div class="modal-footer justify-content-around">
                    <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Batal</button>
                    <a href="../QR/SCANQRTKS67.php">
                        <button type="button" class="btn btn-primary" onclick="EKS9()">Mulai</button></a>
                        <script>
                        function EKS9() {
                            var xhr = new XMLHttpRequest();
                            xhr.open('POST', '../config/insertTKS67.php', true);
