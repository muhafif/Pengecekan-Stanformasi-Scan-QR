...
<body>
                ...
                <div class="card-body">
                    ...
                    <div class="card shadow bg-body-tertiary rounded" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 1)) ,url(https://swamediainc.storage.googleapis.com/swa.co.id/wp-content/uploads/2020/05/12191311/Kereta-APi.jpg);">
                        <div class="card-body" style="justify-content: center; align-items: center; display: flex;">
                            ...
                            data-bs-target="#modalLuxuryTaksaka68"><strong>LUXURY</strong></button>
                        </div>
                    </div>
                    <div class="b-example-divider-main"></div>
                    <div class="card shadow bg-body-tertiary rounded" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 1)) ,url(https://swamediainc.storage.googleapis.com/swa.co.id/wp-content/uploads/2020/05/12191311/Kereta-APi.jpg);">
                        <div class="card-body" style="justify-content: center; align-items: center; display: flex;">
                            <button type="button" class="btn btn-lg" style="color: white;"
                            data-bs-toggle="modal"
                            data-bs-target="#modalEks1Taksaka68"><strong>EKSEKUTIF 1</strong></button>
                        </div>
                    </div>
                    <div class="b-example-divider-main"></div>
                    <div class="card shadow bg-body-tertiary rounded" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 1)) ,url(https://swamediainc.storage.googleapis.com/swa.co.id/wp-content/uploads/2020/05/12191311/Kereta-APi.jpg);">
                        <div class="card-body" style="justify-content: center; align-items: center; display: flex;">
                            <button type="button" class="btn btn-lg" style="color: white;"
                            data-bs-toggle="modal"
                            data-bs-target="#modalEks2Taksaka68"><strong>EKSEKUTIF 2</strong></button>
                        </div>
                    </div>
                    <div class="b-example-divider-main"></div>
                    <div class="card shadow bg-body-tertiary rounded" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 1)) ,url(https://swamediainc.storage.googleapis.com/swa.co.id/wp-content/uploads/2020/05/12191311/Kereta-APi.jpg);">
                        <div class="card-body" style="justify-content: center; align-items: center; display: flex;">
                            <button type="button" class="btn btn-lg" style="color: white;"
                            data-bs-toggle="modal"
                            data-bs-target="#modalEks3Taksaka68"><strong>EKSEKUTIF 3</strong></button>
                        </div>
                    </div>
                    <div class="b-example-divider-main"></div>
                    <div class="card shadow bg-body-tertiary rounded" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 1)) ,url(https://swamediainc.storage.googleapis.com/swa.co.id/wp-content/uploads/2020/05/12191311/Kereta-APi.jpg);">
                        <div class="card-body" style="justify-content: center; align-items: center; display: flex;">
                            <button type="button" class="btn btn-lg" style="color: white;"
                            data-bs-toggle="modal"
                            data-bs-target="#modalEks4Taksaka68"><strong>EKSEKUTIF 4</strong></button>
                        </div>
                    </div>
                    <div class="b-example-divider-main"></div>
                    <div class="card shadow bg-body-tertiary rounded" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 1)) ,url(https://swamediainc.storage.googleapis.com/swa.co.id/wp-content/uploads/2020/05/12191311/Kereta-APi.jpg);">
                        <div class="card-body" style="justify-content: center; align-items: center; display: flex;">
                            <button type="button" class="btn btn-lg" style="color: white;"
                            data-bs-toggle="modal"
                            data-bs-target="#modalEks5Taksaka68"><strong>EKSEKUTIF 5</strong></button>
                        </div>
                    </div>
                    <div class="b-example-divider-main"></div>
                    <div class="card shadow bg-body-tertiary rounded" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 1)) ,url(https://swamediainc.storage.googleapis.com/swa.co.id/wp-content/uploads/2020/05/12191311/Kereta-APi.jpg);">
                        <div class="card-body" style="justify-content: center; align-items: center; display: flex;">
                            <button type="button" class="btn btn-lg" style="color: white;"
                            data-bs-toggle="modal"
                            data-bs-target="#modalEks6Taksaka68"><strong>EKSEKUTIF 6</strong></button>
                        </div>
                    </div>
                    <div class="b-example-divider-main"></div>
                    <div class="card shadow bg-body-tertiary rounded" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 1)) ,url(https://swamediainc.storage.googleapis.com/swa.co.id/wp-content/uploads/2020/05/12191311/Kereta-APi.jpg);">
                        <div class="card-body" style="justify-content: center; align-items: center; display: flex;">
                            <button type="button" class="btn btn-lg" style="color: white;"
                            data-bs-toggle="modal"
                            data-bs-target="#modalEks7Taksaka68"><strong>EKSEKUTIF 7</strong></button>
                        </div>
                    </div>
                    <div class="b-example-divider-main"></div>
                    <div class="card shadow bg-body-tertiary rounded" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 1)) ,url(https://swamediainc.storage.googleapis.com/swa.co.id/wp-content/uploads/2020/05/12191311/Kereta-APi.jpg);">
                    ...
                    <div class="card shadow bg-body-tertiary rounded" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 1)) ,url(https://swamediainc.storage.googleapis.com/swa.co.id/wp-content/uploads/2020/05/12191311/Kereta-APi.jpg);">
                        <div class="card-body" style="justify-content: center; align-items: center; display: flex;">
                            <button type="button" class="btn btn-lg" style="color: white;"
                            data-bs-toggle="modal"
                            data-bs-target="#modalEks9Taksaka68"><strong>EKSEKUTIF 9</strong></button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-4 shadow">
                <div class="modal-body p-4 text-center border-bottom-2">
                    <h5 class="mb-0">Ingin Memulai Scan Stanformasi Luxury Di Kereta Taksaka(68)?</h5>
                    <div class="b-example-divider-main"></div>
    ...
    <div class="modal fade" id="modalEks2Taksaka68" tabindex="-1" aria-labelledby="modalEks2Taksaka68Label" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-4 shadow">
                <div class="modal-body p-4 text-center border-bottom-2">
                    <h5 class="mb-0">Ingin Memulai Scan Stanformasi Eksekutif 2 Di Kereta Taksaka(68)?</h5>
                    <div class="b-example-divider-main"></div>
                    <p class="mb-0">Stanformasi yang dipilih tidak dapat diubah!</p>
                </div>
                <div class="modal-footer justify-content-around">
    ...
    <div class="modal fade" id="modalEks3Taksaka68" tabindex="-1" aria-labelledby="modalEks3Taksaka68Label" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-4 shadow">
                <div class="modal-body p-4 text-center border-bottom-2">
                    <h5 class="mb-0">Ingin Memulai Scan Stanformasi Eksekutif 3 Di Kereta Taksaka(68)?</h5>
                    <div class="b-example-divider-main"></div>
                    <p class="mb-0">Stanformasi yang dipilih tidak dapat diubah!</p>
                </div>
                <div class="modal-footer justify-content-around">
    ...
    <div class="modal fade" id="modalEks4Taksaka68" tabindex="-1" aria-labelledby="modalEks4Taksaka68Label" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-4 shadow">
                <div class="modal-body p-4 text-center border-bottom-2">
                    <h5 class="mb-0">Ingin Memulai Scan Stanformasi Eksekutif 4 Di Kereta Taksaka(68)?</h5>
                    <div class="b-example-divider-main"></div>
                    <p class="mb-0">Stanformasi yang dipilih tidak dapat diubah!</p>
                </div>
                <div class="modal-footer justify-content-around">
    ...
    <div class="modal fade" id="modalEks5Taksaka68" tabindex="-1" aria-labelledby="modalEks5Taksaka68Label" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-4 shadow">
                <div class="modal-body p-4 text-center border-bottom-2">
                    <h5 class="mb-0">Ingin Memulai Scan Stanformasi Eksekutif 5 Di Kereta Taksaka(68)?</h5>
                    <div class="b-example-divider-main"></div>
                    <p class="mb-0">Stanformasi yang dipilih tidak dapat diubah!</p>
                </div>
                <div class="modal-footer justify-content-around">
    ...
    <div class="modal fade" id="modalEks6Taksaka68" tabindex="-1" aria-labelledby="modalEks6Taksaka68Label" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-4 shadow">
                <div class="modal-body p-4 text-center border-bottom-2">
                    <h5 class="mb-0">Ingin Memulai Scan Stanformasi Eksekutif 6 Di Kereta Taksaka(68)?</h5>
                    <div class="b-example-divider-main"></div>
                    <p class="mb-0">Stanformasi yang dipilih tidak dapat diubah!</p>
                </div>
                <div class="modal-footer justify-content-around">
    ...
    <div class="modal fade" id="modalEks7Taksaka68" tabindex="-1" aria-labelledby="modalEks7Taksaka68Label" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-4 shadow">
                <div class="modal-body p-4 text-center border-bottom-2">
                    <h5 class="mb-0">Ingin Memulai Scan Stanformasi Eksekutif 7 Di Kereta Taksaka(68)?</h5>
                    <div class="b-example-divider-main"></div>
                    <p class="mb-0">Stanformasi yang dipilih tidak dapat diubah!</p>
                </div>
                <div class="modal-footer justify-content-around">
    ...
    <div class="modal fade" id="modalEks8Taksaka68" tabindex="-1" aria-labelledby="modalEks8Taksaka68Label" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-4 shadow">
                <div class="modal-body p-4 text-center border-bottom-2">
                    <h5 class="mb-0">Ingin Memulai Scan Stanformasi Eksekutif 8 Di Kereta Taksaka(68)?</h5>
                    <div class="b-example-divider-main"></div>
                    <p class="mb-0">Stanformasi yang dipilih tidak dapat diubah!</p>
                </div>
                <div class="modal-footer justify-content-around">
    ...
    <div class="modal fade" id="modalEks9Taksaka68" tabindex="-1" aria-labelledby="modalEks9Taksaka68Label" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-4 shadow">
                <div class="modal-body p-4 text-center border-bottom-2">
                    <h5 class="mb-0">Ingin Memulai Scan Stanformasi Eksekutif 9 Di Kereta Taksaka(68)?</h5>
                    <div class="b-example-divider-main"></div>
                    <p class="mb-0">Stanformasi yang dipilih tidak dapat diubah!</p>
                </div>
                <div class="modal-footer justify-content-around">
